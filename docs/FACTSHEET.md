...
## 검증된 문장 (생성 2026-08-03 · 24/24 재현 성공)
...
| 수치 | 왜 못 쓰는가 |
|---|---|
| 지수 레벨/누적수익률/CAGR/변동성/MDD/회전율 (잠정 실측치 일체) | 잠정 실행 완료 - FINAL 게이트(D1·D2·D3·판정 추인 2건) 통과 후 make_backtest_manifest.py --final 로 해제 |
| 벤치마크 수익률·상관계수·추적오차 | 벤치마크 PROVISIONAL - resolver·CONFIRMED 반영 재실행 전 |
